...
/**
 * /tests/Unit/Api/V1/Rules/TipoDocumento/Rule0001Test.php.
 *
...
use SuppCore\AdministrativoBackend\Api\V1\Rules\TipoDocumento\Rule0001;
...
class Rule0001Test extends TestCase
{
    ...
    private MockObject|TipoDocumentoDto $tipoDocumentoDto;
    ...
    public function setUp(): void
    {
        ...
        $this->tipoDocumentoDto = $this->createMock(TipoDocumentoDto::class);
    ...
    {
        $this->tipoDocumentoDto->expects(self::once())
            ->method('getNome')
            ->willReturn('CERTIDÃO');
        ...
        $this->rule->validate($this->tipoDocumentoDto, $this->tipoDocumentoEntity, 'transaction');
    }
    ...
    public function testTipoDocumentoNaoCertidao(): void
    {
        ...
        self::assertTrue($this->rule->validate($this->tipoDocumentoDto, $this->tipoDocumentoEntity, 'transaction'));
    }
}
