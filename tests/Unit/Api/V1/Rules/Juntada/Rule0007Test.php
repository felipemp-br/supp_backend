...
/**
 * /tests/Unit/Api/V1/Rules/Juntada/Rule0007Test.php.
 *
...
use SuppCore\AdministrativoBackend\Api\V1\Rules\Juntada\Rule0007;
...
class Rule0007Test extends TestCase
{
    ...
    public function testNupFisico(): void
    {
        ...
        $componentes->add(new ComponenteDigital());
        $componentes->add(new ComponenteDigital());
     ...
     */
    public function testNupNaoFisico(): void
    {
        $componentes = new ArrayCollection();
        $componentes->add(new ComponenteDigital());
        $componentes->add(new ComponenteDigital());
