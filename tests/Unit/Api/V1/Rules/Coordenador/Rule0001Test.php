...
/**
 * /tests/Unit/Api/V1/Rules/Coordenador/Rule0001Test.php.
 *
...
use SuppCore\AdministrativoBackend\Api\V1\Rules\Coordenador\Rule0001;
...
class Rule0001Test extends TestCase
{
    ...
    public function testSemAcessoParaCriarVinculoNaPropriaUnidadeOuOrgaoCentral(): void
    {
        ...
        $this->coordenadorDto->expects(self::exactly(3))
            ->method('getSetor')
            ->willReturn($setor);
