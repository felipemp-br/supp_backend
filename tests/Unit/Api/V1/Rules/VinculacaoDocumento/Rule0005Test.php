...
/**
 * /tests/Unit/Api/V1/Rules/VinculacaoDocumento/Rule0005Test.php.
 *
...
use SuppCore\AdministrativoBackend\Api\V1\Rules\VinculacaoDocumento\Rule0005;
...
class Rule0005Test extends TestCase
{
    ...
    public function testJaVinculado(): void
    {
     ...
     */
    public function testNaoVinculado(): void
    {
        $this->vinculacaoDocumentoRepository->expects(self::once())
            ->method('findByDocumentoVinculado')
            ->willReturn(false);
