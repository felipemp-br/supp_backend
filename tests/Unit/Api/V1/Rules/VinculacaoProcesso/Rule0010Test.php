...
/**
 * /tests/Unit/Api/V1/Rules/VinculacaoProcesso/Rule0010Test.php.
 *
...
use SuppCore\AdministrativoBackend\Api\V1\Rules\VinculacaoProcesso\Rule0010;
...
class Rule0010Test extends TestCase
{
    ...
    public function testTemNUPsVinculados(): void
    {
        $this->vinculacaoProcessoRepository->expects(self::once())
            ->method('findByProcessoPrincipal')
            ->willReturn(true);
     ...
     */
    public function testNaoTemNUPsVinculados(): void
    {
        $this->vinculacaoProcessoRepository->expects(self::once())
            ->method('findByProcessoPrincipal')
            ->willReturn(false);
