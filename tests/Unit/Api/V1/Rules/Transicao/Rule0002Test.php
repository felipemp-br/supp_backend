...
/**
 * /tests/Unit/Api/V1/Rules/Transicao/Rule0002Test.php.
 *
...
use SuppCore\AdministrativoBackend\Api\V1\Rules\Transicao\Rule0002;
...
class Rule0002Test extends TestCase
{
    ...
    public function testNUPNaoEstaNaFaseCorrente(): void
    {
        $this->parameterBag->expects(self::exactly(2))
            ->method('get')
            ->willReturnOnConsecutiveCalls('CORRENTE', 'TRANSFERÊNCIA');
     ...
     */
    public function testNUPNaFaseCorrente(): void
    {
