...
/**
 * /src/Entity/ModalidadeDestinacao.php.
 *
...
#[Enableable]
#[ORM\Table(name: 'ad_mod_destinacao')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeDestinacao implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeDestinacao constructor.
     *
     * @throws Exception
     */
