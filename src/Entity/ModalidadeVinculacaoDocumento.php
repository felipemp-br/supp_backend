...
/**
 * /src/Entity/ModalidadeVinculacaoDocumento.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_vinculacao_documento.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_vinc_documento')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeVinculacaoDocumento implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeVinculacaoDocumento constructor.
     *
     * @throws Exception
     */
