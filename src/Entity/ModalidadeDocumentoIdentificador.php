...
/**
 * /src/Entity/ModalidadeDocumentoIdentificador.php.
 *
...
#[Enableable]
#[ORM\Table(name: 'ad_mod_doc_identificador')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeDocumentoIdentificador implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeDocumentoIdentificador constructor.
     *
     * @throws Exception
     */
