...
/**
 * /src/Entity/ModalidadeInteressado.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_interessado.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_interessado')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeInteressado implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeInteressado constructor.
     *
     * @throws Exception
     */
