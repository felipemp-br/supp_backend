...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_fase.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_fase')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeFase implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
