...
/**
 * /src/Entity/ModalidadeCategoriaSigilo.php.
 *
...
#[Enableable]
#[ORM\Table(name: 'ad_mod_categoria_sigilo')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeCategoriaSigilo implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeCategoriaSigilo constructor.
     *
     * @throws Exception
     */
