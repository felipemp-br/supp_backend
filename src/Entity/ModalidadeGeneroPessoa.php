...
/**
 * /src/Entity/ModalidadeGeneroPessoa.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_genero_pessoa.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_genero_pessoa')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeGeneroPessoa implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeGeneroPessoa constructor.
     *
     * @throws Exception
     */
