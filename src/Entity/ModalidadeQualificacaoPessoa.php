...
/**
 * /src/Entity/ModalidadeQualificacaoPessoa.php.
 *
...
#[Enableable]
#[ORM\Table(name: 'ad_mod_qual_pessoa')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeQualificacaoPessoa implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeQualificacaoPessoa constructor.
     *
     * @throws Exception
     */
