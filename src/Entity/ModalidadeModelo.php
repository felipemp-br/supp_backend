...
/**
 * /src/Entity/ModalidadeModelo.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_modelo.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_modelo')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeModelo implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
