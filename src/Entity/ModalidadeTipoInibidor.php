...
/**
 * /src/Entity/ModalidadeTipoInibidor.php.
 *
...
#[Enableable]
#[ORM\Table(name: 'ad_mod_tipo_inibidor')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeTipoInibidor implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeTipoInibidor constructor.
     *
     * @throws Exception
     */
