...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_meio.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_meio')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeMeio implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
