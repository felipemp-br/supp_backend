...
/**
 * /src/Entity/ModalidadeTransicao.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_transicao.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_transicao')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeTransicao implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeTransicao constructor.
     *
     * @throws Exception
     */
