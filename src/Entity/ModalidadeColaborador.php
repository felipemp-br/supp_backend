...
/**
 * /src/Entity/ModalidadeColaborador.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_colaborador.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_colaborador')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeColaborador implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeColaborador constructor.
     *
     * @throws Exception
     */
