...
/**
 * /src/Entity/ModalidadeEtiqueta.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_etiqueta.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_etiqueta')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeEtiqueta implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeEtiqueta constructor.
     *
     * @throws Exception
     */
