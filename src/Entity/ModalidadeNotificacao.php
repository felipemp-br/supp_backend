...
/**
 * /src/Entity/ModalidadeNotificacao.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_notificacao.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_notificacao')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeNotificacao implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeNotificacao constructor.
     *
     * @throws Exception
     */
