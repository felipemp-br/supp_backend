...
/**
 * /src/Entity/ModalidadeVinculacaoProcesso.php.
 *
...
#[Immutable(
    fieldName: 'valor',
    expressionValues: 'env:constantes.entidades.modalidade_vinculacao_processo.immutable',
    expression: Immutable::EXPRESSION_IN
)]
#[ORM\Table(name: 'ad_mod_vinc_processo')]
#[ORM\UniqueConstraint(columns: ['valor', 'apagado_em'])]
class ModalidadeVinculacaoProcesso implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * ModalidadeVinculacaoProcesso constructor.
     *
     * @throws Exception
     */
