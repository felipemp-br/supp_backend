...
/**
 * AnaliseInicialImovelRural.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class AnaliseInicialImovelRural extends AbstractAnaliseIA implements AnalisaDossiesInterface
{
    /**
    ...
    protected function getInstrucaoAnalise(
        ...
        return <<<EOT
            IMÓVEL RURAL SNCR/CAFIR.
            Passo 1: Se documento for um dossiê sislabra, você deve percorrê-lo e verificar o teor do campo 'Imóveis Rurais 
            SNCR/CAFIR'.
