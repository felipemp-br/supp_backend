...
/**
 * AnaliseProvaMaterialPrevidenciarioEnderecoRuralConjuge.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class AnaliseProvaMaterialPrevidenciarioEnderecoRuralConjuge extends AbstractAnaliseIA implements AnalisaDossiesInterface
{
    /**
    ...
    protected function getInstrucaoAnalise(
        ...
        return <<<EOT
            ...
            Passo 2: Identificadas as informações anteriores, retorne um json com os seguintes campos:
                ...
                'nome_analise': preencha com 'AnaliseEnderecoRuralDosPrevConjuge'.
                'passou_analise': preencha com booleano true se identificar um endereço rural no passo 1.
