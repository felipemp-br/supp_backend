...
/**
 * AnaliseInicialImovelSP.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class AnaliseInicialImovelSP extends AbstractAnaliseIA implements AnalisaDossiesInterface
{
    /**
    ...
    protected function getInstrucaoAnalise(
        ...
        return <<<EOT
            IMÓVEL SP.
            Passo 1: Se o documento for um dossiê sislabra, você deve percorrê-lo e verificar o teor do campo 'Imóveis na 
            Cidade de SP'.
