...
/**
 * AnaliseInicialAeronave.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class AnaliseInicialAeronave extends AbstractAnaliseIA implements AnalisaDossiesInterface
{
    /**
    ...
    protected function getInstrucaoAnalise(
        ...
        return <<<EOT
            AERONAVE. 
            Passo 1: Se documento for um dossiê sislabra, você deve percorrê-lo e verificar o teor do campo 'Aeronaves'.
