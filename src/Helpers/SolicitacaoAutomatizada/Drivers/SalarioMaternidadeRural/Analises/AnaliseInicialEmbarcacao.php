...
/**
 * AnaliseInicialEmbarcacao.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class AnaliseInicialEmbarcacao extends AbstractAnaliseIA implements AnalisaDossiesInterface
{
    /**
    ...
    protected function getInstrucaoAnalise(
        ...
        return <<<EOT
            EMBARCAÇÃO.
            Passo 1: Se documento for um dossiê sislabra, você deve percorrê-lo e verificar o teor do campo 'Embarcações'.
