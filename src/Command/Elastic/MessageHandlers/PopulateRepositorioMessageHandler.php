...
use SuppCore\AdministrativoBackend\Command\Elastic\Messages\PopulateRepositorioMessage;
...
/**
 * Class PopulateRepositorioMessageHandler.
 *
...
class PopulateRepositorioMessageHandler
{
    ...
    /**
     * PopulateRepositorioMessageHandler constructor.
     *
     * @param IndexService              $repositorioIndex
     * @param RepositorioResource       $repositorioResource
    ...
    /**
     * @param PopulateRepositorioMessage $message
     */
    public function __invoke(PopulateRepositorioMessage $message)
    {
        ...
        while ($currentId <= $endId) {
            try {
                $repositorioEntity = $this->repositorioResource->getRepository()->find($currentId);
        ...
        $this->repositorioResource->getRepository()->getEntityManager()->clear();
    }
}
