...
use SuppCore\AdministrativoBackend\BeSimple\SoapCommon\Mime\Part;
...
abstract class SoapMessage
{
     ...
     */
    protected static array $versionToContentTypeMap = [
     ...
     */
    protected ?DOMDocument $contentDomDocument = null;
     ...
     * Set SOAP action.
     *
     * @param array(\SuppCore\AdministrativoBackend\BeSimple\SoapCommon\Mime\Part) $attachments Attachment array
     */
