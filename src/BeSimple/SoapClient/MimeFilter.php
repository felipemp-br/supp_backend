...
use SuppCore\AdministrativoBackend\BeSimple\SoapCommon\Mime\MultiPart as MimeMultiPart;
use SuppCore\AdministrativoBackend\BeSimple\SoapCommon\Mime\Parser as MimeParser;
use SuppCore\AdministrativoBackend\BeSimple\SoapCommon\Mime\Part as MimePart;
...
use SuppCore\AdministrativoBackend\BeSimple\SoapCommon\SoapResponse;
use SuppCore\AdministrativoBackend\BeSimple\SoapCommon\SoapResponseFilter;
...
class MimeFilter implements SoapRequestFilter, SoapResponseFilter
{
     ...
     */
    protected int $attachmentType = Helper::ATTACHMENTS_TYPE_SWA;
    ...
    public function filterRequest(SoapRequest $request)
    {
        ...
        if (count($attachmentsToSend) > 0) {
            ...
            if (SOAP_1_1 == $soapVersion && $this->attachmentType & Helper::ATTACHMENTS_TYPE_MTOM) {
