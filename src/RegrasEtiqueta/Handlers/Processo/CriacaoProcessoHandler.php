...
/**
 * CriacaoProcessoHandler.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class CriacaoProcessoHandler extends AbstractRegrasEtiquetaHandler implements RegrasEtiquetaHandlerInterface
{
    ...
    public function support(RegrasEtiquetaMessage $message): bool
    {
        return Processo::class === $message->getEntityOrigemName()
            && SiglaMomentoDisparoRegraEtiqueta::PROCESSO_CRIACAO_PROCESSO_ADMINISTRATIVO->isEqual(
                $message->getSiglaMomentoDisparoRegraEtiqueta()
            );
    }
