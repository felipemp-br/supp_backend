...
/**
 * /src/DataFixtures/ORM/ProdExec/LoadModalidadeTemplateData.php.
 *
 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadModalidadeTemplateData extends Fixture implements OrderedFixtureInterface, FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $manager->persist($modalidadeTemplate);
