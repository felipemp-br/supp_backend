...
/**
 * /src/DataFixtures/ORM/ProdExec/LoadEspecieRelatorioData.php.
 *
...
class LoadEspecieRelatorioData extends Fixture implements OrderedFixtureInterface, FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $especieRelatorio->setGeneroRelatorio($this->getReference('GeneroRelatorio-GERENCIAL', GeneroRelatorio::class));
        $manager->persist($especieRelatorio);
        $this->addReference(
            'EspecieRelatorio-'.$especieRelatorio->getNome(),
            $especieRelatorio
        ...
        $especieRelatorio->setGeneroRelatorio($this->getReference('GeneroRelatorio-SISTEMA', GeneroRelatorio::class));
        $manager->persist($especieRelatorio);
        $this->addReference(
            'EspecieRelatorio-'.$especieRelatorio->getNome(),
            $especieRelatorio
