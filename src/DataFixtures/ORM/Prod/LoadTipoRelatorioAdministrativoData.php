...
/**
 * /src/DataFixtures/ORM/Prod/LoadTipoRelatorioAdministrativoData.php.
 *
...
class LoadTipoRelatorioAdministrativoData extends Fixture implements OrderedFixtureInterface, FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-FLUXO DE TRABALHO', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-ATIVIDADES', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-COMUNICAÇÕES', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, pd.nome as destinatario, ec.nome as especie, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.especieComunicacao ec INNER JOIN c.setorOrigem so INNER JOIN so.unidade un LEFT JOIN c.pessoaDestino pd LEFT JOIN c.processo p WHERE c.interna = 0 AND c.dataHoraRemessa >= :dataHoraInicio AND c.dataHoraRemessa <= :dataHoraFim AND un.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP as nup_origem, pd.NUP as nup_destino, un.nome as remetente, ec.nome as especie, c.dataHoraRemessa as remessa, DATE_DIFF(CURRENT_DATE(), c.dataHoraRemessa) as dias_pendente FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.especieComunicacao ec LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un INNER JOIN c.setorDestino d LEFT JOIN c.processo p LEFT JOIN c.processoDestino pd WHERE c.dataHoraRemessa IS NOT NULL AND c.interna = 1 AND c.dataHoraResposta IS NULL AND d.id = :unidade ORDER BY p.NUP');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, un.nome as remetente, ec.nome as especie, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.especieComunicacao ec LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un INNER JOIN c.setorDestino d LEFT JOIN c.processo p WHERE c.interna = 1 AND c.dataHoraRemessa >= :dataHoraInicio AND c.dataHoraRemessa <= :dataHoraFim AND d.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT un.nome, count(c.id) as subtotal from SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un INNER JOIN c.setorDestino d WHERE c.interna = 1 AND c.dataHoraRemessa >= :dataHoraInicio AND c.dataHoraRemessa <= :dataHoraFim AND d.id = :unidade GROUP BY un.nome');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, d.nome as destinatario, ec.nome as especie, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.especieComunicacao ec INNER JOIN c.setorOrigem so INNER JOIN so.unidade un LEFT JOIN c.setorDestino d LEFT JOIN c.processo p WHERE c.interna = 1 AND c.dataHoraRemessa >= :dataHoraInicio AND c.dataHoraRemessa <= :dataHoraFim AND un.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT so.nome, count(c.id) as subtotal from SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un WHERE c.interna = 1 AND c.dataHoraRemessa >= :dataHoraInicio AND c.dataHoraRemessa <= :dataHoraFim AND un.id = :unidade GROUP BY so.nome');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, c.interna, CONCAT(d.nome, CONCAT(CONCAT(sd.nome, \'/\'), ud.sigla)) as destinatario, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN c.pessoaDestino d LEFT JOIN c.setorDestino sd LEFT JOIN sd.unidade ud LEFT JOIN c.processo p WHERE c.dataHoraResposta IS NULL AND c.dataHoraRemessa IS NOT NULL AND c.encerrado = 0 AND so.id = :setor');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, c.interna, CONCAT(d.nome, CONCAT(CONCAT(sd.nome, \'/\'), ud.sigla)) as destinatario, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un LEFT JOIN c.pessoaDestino d LEFT JOIN c.setorDestino sd LEFT JOIN sd.unidade ud LEFT JOIN c.processo p WHERE c.dataHoraResposta IS NULL AND c.dataHoraRemessa IS NOT NULL AND c.encerrado = 0 AND un.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, c.interna, CONCAT(d.nome, CONCAT(CONCAT(sd.nome, \'/\'), ud.sigla)) as destinatario, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un LEFT JOIN c.pessoaDestino d LEFT JOIN c.setorDestino sd LEFT JOIN sd.unidade ud LEFT JOIN c.processo p WHERE c.dataHoraResposta IS NULL AND c.dataHoraRemessa IS NOT NULL AND c.encerrado = 0 AND ud.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, c.interna, CONCAT(d.nome, CONCAT(CONCAT(sd.nome, \'/\'), ud.sigla)) as destinatario, ec.nome as especie, c.dataHoraRemessa as remessa, DATE_DIFF(CURRENT_DATE(), c.dataHoraRemessa) as dias_pendente FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.especieComunicacao ec INNER JOIN c.setorOrigem so INNER JOIN so.unidade un LEFT JOIN c.pessoaDestino d LEFT JOIN c.setorDestino sd LEFT JOIN sd.unidade ud LEFT JOIN c.processo p WHERE c.dataHoraRemessa IS NOT NULL AND c.interna = 1 AND c.dataHoraResposta IS NULL AND un.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setDQL('SELECT d,usr FROM SuppCore\AdministrativoBackend\Entity\Distribuicao d INNER JOIN d.usuarioResponsavelPosterior usr WHERE d.criadoEm >= :dataHoraInicio AND d.criadoEm <= :dataHoraFim AND d.setorResponsavelPosterior = :setor');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);

        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-RECURSOS HUMANOS', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-PROCESSOS/DOCUMENTOS AVULSOS', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('setor,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT p.id, p.NUP, p.criadoEm as data_hora from SuppCore\AdministrativoBackend\Entity\Processo p LEFT JOIN p.numeroUnicoProtocolo n LEFT JOIN n.setor s WHERE p.criadoEm >= :dataHoraInicio AND p.criadoEm <= :dataHoraFim AND s.id = :setor');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('setor,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT s.nome, count(p.id) as subtotal from SuppCore\AdministrativoBackend\Entity\Processo p LEFT JOIN p.numeroUnicoProtocolo n LEFT JOIN n.setor s WHERE p.criadoEm >= :dataHoraInicio AND p.criadoEm <= :dataHoraFim AND s.id = :setor GROUP BY s.nome');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT p.id, p.NUP, p.criadoEm as data_hora from SuppCore\AdministrativoBackend\Entity\Processo p LEFT JOIN p.numeroUnicoProtocolo n LEFT JOIN n.setor s LEFT JOIN s.unidade u WHERE p.criadoEm >= :dataHoraInicio AND p.criadoEm <= :dataHoraFim AND u.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade,dataHoraInicio,dataHoraFim');
        $tipoRelatorio->setDQL('SELECT u.nome, count(p.id) as subtotal from SuppCore\AdministrativoBackend\Entity\Processo p LEFT JOIN p.numeroUnicoProtocolo n LEFT JOIN n.setor s LEFT JOIN s.unidade u WHERE p.criadoEm >= :dataHoraInicio AND p.criadoEm <= :dataHoraFim AND u.id = :unidade GROUP BY u.nome');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
...
LEFT JOIN p.acompanhamentos ac
LEFT JOIN ac.usuario us
LEFT JOIN p.setor s 
WHERE ac.apagadoEm IS NULL AND ac.usuario = :usuario');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);

        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-USUÁRIOS', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-TABELAS', EspecieRelatorio::class)
        );
...
ORDER BY m.valor ASC, u.nome ASC');
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros(' ');
        $tipoRelatorio->setDQL('SELECT u.nome as usuario, u.email, p.nome as pessoa FROM SuppCore\AdministrativoBackend\Entity\Usuario u INNER JOIN u.vinculacoesUsuariosPessoas vup INNER JOIN vup.pessoa p WHERE u.colaborador IS NULL AND u.enabled = 1 ORDER BY u.nome, p.nome');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-TAREFAS', EspecieRelatorio::class)
        );
...
WHERE t.dataHoraConclusaoPrazo >= :dataHoraInicio AND t.dataHoraConclusaoPrazo <= :dataHoraFim AND u.id = :unidade');
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-TRAMITAÇÕES', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('setor');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, d.nome as destinatario, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN c.pessoaDestino d LEFT JOIN c.processo p WHERE c.dataHoraResposta IS NULL AND c.dataHoraRemessa IS NOT NULL AND c.encerrado = 0 AND so.id = :setor');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade');
        $tipoRelatorio->setDQL('SELECT c.id, p.NUP, d.nome as destinatario, c.dataHoraRemessa as remessa FROM SuppCore\AdministrativoBackend\Entity\Comunicacao c LEFT JOIN c.setorOrigem so LEFT JOIN so.unidade un LEFT JOIN c.pessoaDestino d LEFT JOIN c.processo p WHERE c.dataHoraResposta IS NULL AND c.dataHoraRemessa IS NOT NULL AND c.encerrado = 0 AND un.id = :unidade');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
        $tipoRelatorio->setParametros('unidade');
        $tipoRelatorio->setDQL('SELECT p.id, p.NUP, s.nome FROM SuppCore\AdministrativoBackend\Entity\Processo p INNER JOIN p.setor s INNER JOIN s.unidade u WITH u.id = :unidade WHERE p.encerrado = 0 AND (SELECT MAX(t.dataHoraConclusaoPrazo) FROM SuppCore\AdministrativoBackend\Entity\Tarefa t LEFT JOIN t.processo tp WHERE tp.id = p.id) < DATE_SUB(CURRENT_DATE(), 10, \'day\') ORDER BY s.nome ASC');
        $manager->persist($tipoRelatorio);
        $this->addReference('TipoRelatorio-'.$tipoRelatorio->getNome(), $tipoRelatorio);
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-PLANO DE CLASSIFICAÇÃO', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-TABELA DE TEMPORALIDADE', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-FLUXO DE TRAMITAÇÕES', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-FLUXO DE TAREFAS', EspecieRelatorio::class)
        );
        ...
        $tipoRelatorio = new TipoRelatorio();
        $tipoRelatorio->setEspecieRelatorio(
            $this->getReference('EspecieRelatorio-HISTÓRICO', EspecieRelatorio::class)
        );
