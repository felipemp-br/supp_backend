...
class LoadLotacaoData extends Fixture implements OrderedFixtureInterface, FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $lotacao = new Lotacao();
        $lotacao->setColaborador($this->getReference('Colaborador-00000000006', Colaborador::class));
        ...
        $lotacao = new Lotacao();
        $lotacao->setColaborador($this->getReference('Colaborador-00000000007', Colaborador::class));
        $lotacao->setSetor($this->getReference('Setor-PROTOCOLO-PGF-SEDE', Setor::class));
        $lotacao->setPrincipal(true);
        ...
        $lotacao = new Lotacao();
        $lotacao->setColaborador($this->getReference('Colaborador-00000000008', Colaborador::class));
        ...
        $lotacao = new Lotacao();
        $lotacao->setColaborador($this->getReference('Colaborador-00000000010', Colaborador::class));
        $lotacao->setSetor($this->getReference('Setor-PROTOCOLO-PGF-SEDE', Setor::class));
        $lotacao->setPrincipal(true);
        ...
        $lotacao = new Lotacao();
        $lotacao->setColaborador($this->getReference('Colaborador-00000000011', Colaborador::class));
        $lotacao->setSetor($this->getReference('Setor-PROTOCOLO-AGU-SEDE', Setor::class));
        $lotacao->setPrincipal(true);
        ...
        $lotacao = new Lotacao();
        $lotacao->setColaborador($this->getReference('Colaborador-00000000012', Colaborador::class));
        $lotacao->setSetor($this->getReference('Setor-ARQUIVO-PGF-SEDE', Setor::class));
        $lotacao->setPrincipal(true);
