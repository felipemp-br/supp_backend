...
class LoadModalidadeVinculacaoProcessoData extends Fixture implements OrderedFixtureInterface, FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $modalidadeVinculacaoProcesso->setValor('DESAPENSAMENTO');
        $modalidadeVinculacaoProcesso->setDescricao('DESAPENSAMENTO');

        $manager->persist($modalidadeVinculacaoProcesso);

        $this->addReference(
            'ModalidadeVinculacaoProcesso-'.$modalidadeVinculacaoProcesso->getValor(),
