...
namespace SuppCore\AdministrativoBackend\InteligenciaArtificial\Triagem\Trilhas\PeticaoInicialGestaoConhecimento;
...
use SuppCore\AdministrativoBackend\InteligenciaArtificial\Triagem\Trilhas\PeticaoInicialGestaoConhecimento\Prompts\Prompt0001;
use SuppCore\AdministrativoBackend\InteligenciaArtificial\Triagem\Trilhas\PeticaoInicialGestaoConhecimento\Prompts\Prompt0002;
use SuppCore\AdministrativoBackend\InteligenciaArtificial\Triagem\Trilhas\PeticaoInicialGestaoConhecimento\Prompts\Prompt0003;
 ...
 */
#[Trilha(
    nome: 'Trilha de Gestão de Conhecimento da Petição Inicial',
    prompts: [
        Prompt0001::class => [
            Prompt0002::class,
            Prompt0003::class,
...
class TrilhaPeticaoInicialGestaoConhecimento extends BaseTrilhaTriagem implements TrilhaTriagemInterface
{
    public const CONFIG_MODULO_KEY = 'ADMINISTRATIVO_TRILHA_GESTAO_CONHECIMENTO_PETICAO_INICIAL';
    public array $config = [
        'ativo' => false,
    ...
    {
        return 'ia_gestao_conhecimento_petini_1';
    }
