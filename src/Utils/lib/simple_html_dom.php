...
namespace SuppCore\AdministrativoBackend\Utils\lib;
...
class simple_html_dom_node
{
     ...
     * ```
     *
     * @see https://www.w3.org/TR/selectors/#compound Compound selector
     */
    ...
    public function convert_text($text)
    {
        ...
        if (!empty($sourceCharset)
            && !empty($targetCharset)
            && (0 != strcasecmp($sourceCharset, $targetCharset))) {
            // Check if the reported encoding could have been incorrect and the text is actually already UTF-8
            if ((0 == strcasecmp($targetCharset, 'UTF-8'))
                && ($this->is_utf8($text))) {
                $converted_text = $text;
            } else {
 ...
 */
#[AllowDynamicProperties] class simple_html_dom
{
    /**
     ...
     *
     * @see https://www.w3.org/TR/html HTML Specification
     * @see https://www.w3.org/TR/html/syntax.html#void-elements Void elements
     */
     ...
     *
     * @see https://www.w3.org/TR/html/syntax.html#optional-tags Optional tags
     *
    ...
    public function restore_noise($text)
    {
        ...
        while (false !== ($pos = strpos($text, '___noise___'))) {
