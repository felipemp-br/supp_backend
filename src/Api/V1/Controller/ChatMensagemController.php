...
/**
 * /src/Controller/ChatMensagemController.php.
 */

namespace SuppCore\AdministrativoBackend\Api\V1\Controller;

use OpenApi\Attributes as OA;
use SuppCore\AdministrativoBackend\Api\V1\Resource\ChatMensagemResource as ApiResource;
 ...
 */
#[Route(path: '/v1/administrativo/chat_mensagem')]
#[IsGranted('IS_AUTHENTICATED_FULLY')]
#[OA\Tag(name: 'ChatMensagem')]
