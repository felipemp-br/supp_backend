 ...
 * Class Trigger0028.
 *
 * @descSwagger=Os processos vinculados também devem ser enviados para o Setor Atual do NUP Principal
...
class Trigger0028 implements TriggerInterface
{
     ...
     */
    public function execute(Processo|RestDtoInterface|null $restDto, ProcessoEntity|EntityInterface $entity, string $transactionId): void
    {
        if($restDto->getSetorAtual()->getId() !== $entity->getSetorAtual()->getId()) {
            ...
            foreach ($vinculacoesProcessos as $vinculacoes){
                ...
                $processoVinculado->setSetorAtual($restDto->getSetorAtual());
