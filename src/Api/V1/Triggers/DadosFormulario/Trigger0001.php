 ...
 * Class Trigger0001.
 *
 * @descSwagger=Caso seja passado um componente digital, a trigger pega o documento deste componente digital e o seta.
 *
...
class Trigger0001 implements TriggerInterface
{
    ...
    {
        if ($restDto->getComponenteDigital()?->getDocumento()) {
            $restDto->setDocumento($restDto->getComponenteDigital()->getDocumento());
        }
    }
