...
/**
 * /src/Api/V1/Pipes/Interessado/Pipe0001.php.
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */

namespace SuppCore\AdministrativoBackend\Api\V1\Mapper\Pipes\Interessado;
...
class Pipe0001 implements PipeInterface
{
    ...
    /**
     * @param InteressadoEntity|EntityInterface $entity
     *
     * @throws Exception
     */
