...
/**
 * /src/Api/V1/Rules/Tarefa/Rule0023.php.
 *
 ...
 * Class Rule0023.
 *
 * @descSwagger=Não é possível dar ciência em tarefas de workflow!
...
class Rule0023 implements RuleInterface
{
    ...
    {
        if ($entity->getVinculacaoWorkflow()) {
            $this->rulesTranslate->throwException('tarefa', '0023');
        }
