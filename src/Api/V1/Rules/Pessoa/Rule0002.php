...
/**
 * /src/Api/V1/Rules/Pessoa/Rule0002.php.
 *
 ...
 * Class Rule0002.
 *
 * @descSwagger=Não é possível alterar nome de pessoa quando possuir menos de 60% de similaridade!
...
class Rule0002 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        ...
        \similar_text(
            StringService::utf82short($restDto->getNome()),
            StringService::utf82short($entity->getNome()),
            $percentualCalculado
        );

        if (false === $this->authorizationChecker->isGranted('ROLE_ADMIN') &&
            $percentualCalculado < 60) {
            $this->rulesTranslate->throwException('pessoa', '0004');
        }
