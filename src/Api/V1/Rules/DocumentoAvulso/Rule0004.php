...
/**
 * /src/Api/V1/Rules/DocumentoAvulso/Rule0004.php.
 *
 ...
 * Class Rule0004.
 *
 * @descSwagger=Apenas ofícios remetidos podem ser reiterados
...
class Rule0004 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        ...
        if (!$restDto->getDataHoraRemessa()) {
            $this->rulesTranslate->throwException('documentoAvulso', '0004');
        }
