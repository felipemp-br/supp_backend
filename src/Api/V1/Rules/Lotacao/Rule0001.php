...
/**
 * /src/Api/V1/Rules/Lotacao/Rule0001.php.
 *
 ...
 * Class Rule0001.
 *
 * @descSwagger=O usuário não pode ser lotado diretamente na Unidade! Selecione um setor!
...
class Rule0001 implements RuleInterface
{
    ...
    {
        if (false === $restDto->getSetor()->getParent()) {
            $this->rulesTranslate->throwException('lotacao', '0001');
        }
