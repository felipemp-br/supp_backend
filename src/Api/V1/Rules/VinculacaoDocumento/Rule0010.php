...
/**
 * /src/Api/V1/Rules/VinculacaoDocumento/Rule0010.php.
 *
 ...
 * Class Rule0010.
 *
 * @descSwagger=Esse documento foi recebido via barramento/integração e não pode ser vinculado!
...
class Rule0010 implements RuleInterface
{
    ...
    {
        if ($restDto->getDocumento()->getOrigemDados() &&
            'BARRAMENTO_PEN' === $restDto->getDocumento()->getOrigemDados()->getFonteDados()) {
            $this->rulesTranslate->throwException('vinculacaoDocumento', '0010');
        }
