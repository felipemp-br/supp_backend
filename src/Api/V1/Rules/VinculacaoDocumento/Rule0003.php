...
/**
 * /src/Api/V1/Rules/VinculacaoDocumento/Rule0003.php.
 *
 ...
 * Class Rule0003.
 *
 * @descSwagger=Duas minutas vinculas à comunicações não podem ser vinculadas entre si!
...
class Rule0003 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        if ($restDto->getDocumento()->getDocumentoAvulsoRemessa() && $restDto->getDocumentoVinculado()->getDocumentoAvulsoRemessa()) {
            $this->rulesTranslate->throwException('vinculacaoDocumento', '0003');
        }
