...
/**
 * /src/Api/V1/Rules/RelacionamentoPessoal/Rule0003.php.
 *
...
class Rule0003 implements RuleInterface
{
    ...
    /**
     * @param \SuppCore\AdministrativoBackend\Api\V1\DTO\RelacionamentoPessoal|RestDtoInterface|null $restDto
     * @param RelacionamentoPessoal|EntityInterface                                                  $entity
     *
