...
/**
 * /src/Api/V1/Rules/RelacionamentoPessoal/Rule0002.php.
 *
 ...
 * Class Rule0002.
 *
 * @descSwagger=Relacionamentos pessoais criados pela integração não podem ser editados pelos usuários!
...
class Rule0002 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        if ($entity->getOrigemDados()) {
            $this->rulesTranslate->throwException('relacionamentoPessoal', '0002');
        }
