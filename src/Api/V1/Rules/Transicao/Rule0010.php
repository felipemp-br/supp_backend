...
/**
 * /src/Api/V1/Rules/Transicao/Rule0010.php.
 *
 ...
 * Class Rule0010.
 *
 * @descSwagger=O NUP possui sigilo e não pode ser eliminado!
...
class Rule0010 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        if ($this->parameterBag->get('constantes.entidades.modalidade_transicao.const_5') === $restDto->getModalidadeTransicao()->getValor() &&
            $restDto->getProcesso()->getAcessoRestrito()
        ) {
            $this->rulesTranslate->throwException('transicao', '0010');
        }
