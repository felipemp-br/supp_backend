...
/**
 * /src/Api/V1/Rules/Transicao/Rule0002.php.
 *
 ...
 * Class Rule0002.
 *
 * @descSwagger=O NUP não está atualmente na Fase Corrente!
...
class Rule0002 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        if ($this->parameterBag->get('constantes.entidades.modalidade_fase.const_1') !== $restDto->getProcesso()->getModalidadeFase()->getValor() &&
            $this->parameterBag->get('constantes.entidades.modalidade_transicao.const_1') === $restDto->getModalidadeTransicao()->getValor()) {
            $this->rulesTranslate->throwException('transicao', '0002');
        }
