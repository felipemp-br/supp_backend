 ...
 * Class Rule0001.
 *
 * @descSwagger=Verifica se o usuário tem permissão para alterar o Repositório.
...
class Rule0001 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        ...
        $setores = $entity->getVinculacoesRepositorios()
            ->filter(fn (VinculacaoRepositorio $vinculacaoRepositorio) => $vinculacaoRepositorio->getSetor())
        ...
        $unidades = $entity->getVinculacoesRepositorios()
            ->filter(fn (VinculacaoRepositorio $vinculacaoRepositorio) => $vinculacaoRepositorio->getUnidade())
        ...
        $orgaosCentral = $entity->getVinculacoesRepositorios()
            ->filter(fn (VinculacaoRepositorio $vinculacaoRepositorio) => $vinculacaoRepositorio->getModalidadeOrgaoCentral())
