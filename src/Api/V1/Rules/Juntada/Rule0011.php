...
/**
 * /src/Api/V1/Rules/Juntada/Rule0011.php.
 *
 ...
 * Class Rule0011.
 *
 * @descSwagger=A minuta está vinculada à comunicação! Efetue a juntada pela remessa da comunicação!
...
class Rule0011 implements RuleInterface
{
    ...
    {
        if ($restDto->getDocumento()->getDocumentoAvulsoRemessa() && !$restDto->getDocumento()->getJuntadaAtual()
            && !$restDto->getDocumentoAvulso()) {
            $this->rulesTranslate->throwException('juntada', '0011');
        }
