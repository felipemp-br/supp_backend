...
/**
 * /src/Api/V1/Rules/VinculacaoEtiqueta/Rule0006.php.
 *
 ...
 * Class Rule0006.
 *
 * @descSwagger=O usuário não tem direito de excluir a etiqueta do documento
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        if ($entity->getDocumento() &&
            ...
            if (!$usuario->getColaborador()) {
                $this->rulesTranslate->throwException('vinculacao_etiqueta', '0006');
            }
            // pode editar?
