...
/**
 * /src/Api/V1/Rules/Setor/Rule0002.php.
 *
...
class Rule0002 implements RuleInterface
{
    ...
    public function validate(?RestDtoInterface $restDto, EntityInterface $entity, string $transactionId): bool
    {
        ...
        if (($restDto->getEspecieSetor()->getId() !== $entity->getEspecieSetor()->getId()) &&
            ($this->parameterBag->get('constantes.entidades.especie_setor.const_1') === $restDto->getEspecieSetor()->getNome() ||
                $this->parameterBag->get('constantes.entidades.especie_setor.const_2') === $restDto->getEspecieSetor()->getNome())) {
            $this->rulesTranslate->throwException('setor', '0002');
        }
