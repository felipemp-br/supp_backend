...
/**
 * /src/Api/V1/Rules/Volume/Rule0002.php.
 *
 ...
 * Class Rule0002.
 *
 * @descSwagger=Processos físicos não podem ter volumes eletrônicos!
...
class Rule0002 implements RuleInterface
{
    ...
    {
        if ($this->parameterBag->get('constantes.entidades.modalidade_meio.const_2') === $restDto->getProcesso()->getModalidadeMeio()->getValor() &&
            $this->parameterBag->get('constantes.entidades.modalidade_meio.const_1') === $restDto->getModalidadeMeio()->getValor()) {
            $this->rulesTranslate->throwException('volume', '0002');
        }
